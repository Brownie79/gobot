...
[![GoDoc](https://godoc.org/github.com/Brownie79/gobot?status.svg)](https://godoc.org/github.com/Brownie79/gobot)
...
Get the Gobot source with: `go get -d -u github.com/Brownie79/gobot/...`
...
import (
	...
	"github.com/Brownie79/gobot"
	"github.com/Brownie79/gobot/platforms/sphero"
)
...
To activate the API, import the `github.com/Brownie79/gobot/api` package and instantiate the `API` like this:
